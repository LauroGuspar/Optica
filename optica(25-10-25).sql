...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2025 a las 03:24:34
...
--
ALTER TABLE `cliente`
  MODIFY `id_cliente` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `venta`
  MODIFY `id_venta` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
