...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2025 a las 05:52:26
...
CREATE TABLE `categoria` (
  ...
  `categ_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cliente` (
  ...
  `cli_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cli_apellido_paterno` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cli_apellido_materno` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cli_correo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cli_telefono` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cli_direccion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cli_estado` int NOT NULL DEFAULT '1',
  `cli_ndocumento` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tipodocumento` bigint NOT NULL,
  `cli_nombre_empresa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cli_direccion_empresa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `cliente` (`id_cliente`, `cli_nombre`, `cli_apellido_paterno`, `cli_apellido_materno`, `cli_correo`, `cli_telefono`, `cli_direccion`, `cli_estado`, `cli_ndocumento`, `id_tipodocumento`, `cli_nombre_empresa`, `cli_direccion_empresa`) VALUES
(1, 'UNIVERSIDAD TECNOLOGICA DEL PERU S.A.C. O UTP S.A.C.', '', '', '', '', 'CAL. NATALIO SANCHEZ NRO. 125 URB. SANTA BEATRIZ, LIMA, LIMA, LIMA', 1, '20462509236', 2, NULL, NULL),
(2, 'GONZALO ADRIANO', 'SANTOS', 'VARGAS', 'gonzaloadriano@gmail.com', '999888777', 'URB. QUINTA LAS CASUARINAS MZ. E LT. 4, YANAHUARA, AREQUIPA, AREQUIPA', 1, '74140240', 1, NULL, NULL),
(3, 'NELIDA', 'ESPIL', 'HERRERA', NULL, NULL, 'CALLE 9 ASOC. LOS CHASQUIS MZ. M LT. 18A, SAN MARTIN DE PORRES, LIMA, LIMA', 1, '74140241', 1, NULL, NULL),
(5, 'RUBEN JHOSBET', 'VIDAL', 'TICONA', NULL, NULL, 'TENIENTE RODRIGUEZ 410, MIRAFLORES, AREQUIPA, AREQUIPA', 1, '74140245', 1, NULL, NULL),
(6, 'DANILO BRYAN', 'VALDIVIA', 'LLAIQUE', NULL, NULL, 'AV. PERU 100 URB TUPAC AMARU, CERRO COLORADO, AREQUIPA, AREQUIPA', 1, '74140246', 1, NULL, NULL),
(7, 'JHONY WILBER', 'CCAPIRA', 'HUAMANI', NULL, NULL, 'AV. DEAN VALDIVIA AH. LEON DEL SUR MZ. K LT. 4, JACOBO HUNTER, AREQUIPA, AREQUIPA', 1, '74140243', 1, NULL, NULL),
(8, 'JEAN PABLO', 'VALDIVIA', 'LLAIQUE', NULL, NULL, 'AV. PERU 100 URB TUPAC AMARU, CERRO COLORADO, AREQUIPA, AREQUIPA', 1, '74140244', 1, NULL, NULL);
...
CREATE TABLE `compania_transporte` (
  ...
  `transport_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `contacto` (
  ...
  `contac_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contac_apellido_paterno` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contac_apellido_materno` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contac_telefono` char(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contac_observaciones` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `detalle_ventas` (`id_producto`, `id_venta`, `cantidad`, `precio`, `subtotal`) VALUES
(1, 4, 10, 100.00, 1000.00),
(2, 1, 1, 250.00, 250.00),
(2, 2, 1, 250.00, 250.00),
(2, 3, 1, 250.00, 250.00),
(3, 5, 10, 90.00, 900.00),
...
CREATE TABLE `direccion_entrega` (
  ...
  `entregadirec_mombre_cliente` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entregadirec_telefono` char(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entregadirec_provincia` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entregadirec_direccion` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_cliente` bigint NOT NULL,
  `id_venta` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `empleado` (
  ...
  `emple_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_nombreuser` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_apellido_paterno` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_apellido_materno` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_correo` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_contrasena` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_telefono` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_direccion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `emple_estado` int NOT NULL DEFAULT '1',
  `emple_ndocumento` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tipodocumento` bigint NOT NULL,
...
CREATE TABLE `empresa` (
  ...
  `empresa_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `empresa_direccion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `empresa_ruc` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `empresa_logo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `empresa_sidebar` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `forma_pago` (
  ...
  `fpago_metodo` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marca` (
  ...
  `marca_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `opcion` (
  ...
  `opcion_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `opcion_ruta` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `opcion_icon` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orden` (
  ...
  `order_nombre_transportista` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_direccion_envio` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_ciudad` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_provincia` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_transporte` bigint NOT NULL,
  `id_proveedor` bigint NOT NULL,
  `id_empleado` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pagos_credito_detalle` (`id_pago_detalle`, `comentarios`, `estado`, `fecha_pago`, `fecha_vencimiento`, `medio_pago`, `monto`, `monto_pagado`, `numero_cuota`, `id_venta`) VALUES
(1, NULL, 'PAGADO', '2025-10-26 21:21:34.369219', '2025-11-11', 'TARJETA', 300.00, 0.00, 1, 4),
(2, NULL, 'PAGADO', '2025-10-26 21:21:40.427914', '2025-11-26', 'TARJETA', 300.00, 0.00, 2, 4),
(3, NULL, 'PAGADO', '2025-10-26 21:21:45.159910', '2025-12-11', 'TARJETA', 300.00, 0.00, 3, 4);
...
CREATE TABLE `perfil` (
  `id_perfil` bigint NOT NULL,
  `perfil_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `perfil_descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `producto` (
  `id_producto` bigint NOT NULL,
  `produc_nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `produc_codigo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `produc_modelo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `produc_descripcion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `produc_imagen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Lentes de sol', '11223344', NULL, 'Test', 100.00, NULL, NULL, 10, 10, 'Unisex\\7586365e-8638-48ad-ac42-dbccf54f2ad8_Lentes Lectura.jpg', 1, 1, 4, 3),
(2, 'Lentes ópticos', '55667788', NULL, 'Lentes ópticos graduados', 250.00, NULL, NULL, 12, 3, 'Mujer\\87f86932-aa00-4ae3-8649-dddfbd98a124_Lentes Opticos.jpg', 1, 1, 3, 3),
(3, 'Lentes de lectura', '33445566', NULL, 'Lentes de lectura ligeros', 90.00, NULL, NULL, 15, 5, 'Mujer\\d12fed4d-d9f0-40c1-8646-78a2da5200ee_Sin-titulo-136-1.jpg', 1, 1, 3, 1),
...
(5, 'Prueba', '11335566', NULL, 'Prueba', 100.00, NULL, NULL, 9, 5, 'Unisex\\e3936011-f5c1-4f6d-9df7-39156558dd01_Lentes Opticos.jpg', 1, 1, 4, 2);
...
CREATE TABLE `proveedor` (
  `id_proveedor` bigint NOT NULL,
  `provee_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_nombre_comercial` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_nacionalidad` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_direccion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_telefono` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_correo` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provee_correo_adicional` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provee_estado` int NOT NULL DEFAULT '1',
  `provee_ndocumento` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tipodocumento` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipo_documento` (
  `id_tipodocumento` bigint NOT NULL,
  `tipodoc_nombre` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tipo_venta` (
  ...
  `tipoventa_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `unidad` (
  `id_unidad` int NOT NULL,
  `uni_nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `venta` (
  ...
  `forma_pago` enum('CONTADO','CREDITO') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `medio_pago` enum('EFECTIVO','TARJETA','TRANSFERENCIA','YAPE') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `venta` (`id_venta`, `id_cliente`, `cuotas`, `deuda`, `estado`, `fecha`, `fecha_vencimiento`, `forma_pago`, `medio_pago`, `numero_documento`, `pago_inicial`, `total`, `id_tipo_comprobante`, `id_usuario`, `venta_fecha`) VALUES
(1, 2, NULL, NULL, 1, NULL, NULL, 'CONTADO', NULL, '00000001', NULL, 250.00, 1, 1, '2025-10-26 21:13:47.273902'),
(2, 5, NULL, NULL, 1, NULL, NULL, 'CONTADO', NULL, '00000002', NULL, 350.00, 1, 1, '2025-10-26 21:15:25.431606'),
(3, 5, NULL, NULL, 1, NULL, NULL, 'CONTADO', NULL, '00000003', NULL, 250.00, 1, 1, '2025-10-26 21:20:36.283204'),
(4, 5, 3, 0.00, 1, NULL, '2025-12-11', 'CREDITO', NULL, '00000004', 100.00, 1000.00, 1, 1, '2025-10-26 21:21:23.178291'),
(5, 8, NULL, NULL, 1, NULL, NULL, 'CONTADO', NULL, '00000001', NULL, 900.00, 2, 1, '2025-10-26 23:20:21.688106');
...
--
ALTER TABLE `cliente`
  MODIFY `id_cliente` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `empresa_sidebar_imagen`
  MODIFY `id_imagen` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `forma_pago`
--
ALTER TABLE `forma_pago`
  MODIFY `id_fpago` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `opcion`
  MODIFY `id_opcion` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `pagos_credito_detalle`
  MODIFY `id_pago_detalle` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `proveedor`
  MODIFY `id_proveedor` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tipo_venta`
  MODIFY `id_tipoventa` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `venta`
  MODIFY `id_venta` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
