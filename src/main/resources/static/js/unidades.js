$(document).ready(function () {
    ...
    const API_BASE = '/productos/unidades/api';
    const ENDPOINTS = {
    ...
    function handleEdit() {
        ...
        fetch(ENDPOINTS.get(id))
            ...
            .then(data => {
                ...
                } else { AppUtils.showNotification('Error al cargar unidad', 'error'); }
            })
            .catch(error => AppUtils.showNotification('Error de conexión', 'error'))
            .finally(() => AppUtils.showLoading(false));
    }
    ...
    function handleDelete() {
        const id = $(this).data('id');
        Swal.fire({
            title: '¿Estás seguro?', text: "¡La unidad será marcada como eliminada!",
